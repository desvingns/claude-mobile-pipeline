...
```bash
bash $MP_SCRIPTS/mp-pixel-diff.sh --reference <reference.png> --built <built.png> --out build/fit/diff/<screen_id>.png
```
...
```bash
bash "$MP_SCRIPTS/mp-brain-memory.sh" append-candidate \
